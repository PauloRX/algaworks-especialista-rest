...
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_logradouro, endereco_numero, endereco_complemento, endereco_cep, endereco_bairro, endereco_cidade_id, data_cadastro, data_atualizacao) values ('Fasano', 7.5, 3, 'Av Sete de Setembro', '2030', '', '02036022', 'Santana', 3, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_logradouro, endereco_numero, endereco_complemento, endereco_cep, endereco_bairro, endereco_cidade_id, data_cadastro, data_atualizacao) values ('Terraço Italia', 12.5, 3, 'Av Nove de Julho', '1922', '', '03409000', 'Bela Cintra', 3, utc_timestamp, utc_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (3, 'Outback', 12, 3, utc_timestamp, utc_timestamp);
